...
const Hero = () => {
  ...
  return (
    <>
      ...
      <section
        className="theme-section relative w-full h-[100dvh] bg-[#F1EFE7] text-[#050505] dark:bg-[#050505] dark:text-white overflow-hidden selection:bg-[#FF3355] selection:text-white transition-colors duration-500"
        ...
        <div className="relative z-10 w-full h-full flex flex-col justify-center px-5 sm:px-6 md:px-12 max-w-[1800px] mx-auto pt-24 md:pt-0">
          ...
          <div className="relative z-20 flex flex-col md:flex-row items-center justify-center md:justify-between w-full mt-16 md:mt-0 h-full gap-8 md:gap-0">
            ...
            >
              ...
              <div className="absolute bottom-0 w-full h-1/4 bg-gradient-to-t from-[#F1EFE7] to-transparent dark:from-[#050505] z-20" />
            </motion.div>
