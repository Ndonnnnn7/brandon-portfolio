...
const About = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="theme-section relative min-h-[100svh] w-full bg-[#F1EFE7] text-[#050505] dark:bg-[#0a0a0a] dark:text-white overflow-hidden font-sans selection:bg-[#FF3355] selection:text-white transition-colors duration-500"
    >
      <div
