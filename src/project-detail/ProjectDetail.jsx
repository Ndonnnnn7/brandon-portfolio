...
const ProjectDetail = () => {
  ...
  return (
    <>
      {!project ? (
        <div className="theme-section min-h-screen flex flex-col gap-4 items-center justify-center text-[#050505] bg-[#F1EFE7] dark:text-white dark:bg-[#050505] font-mono">
        ...
        <article
          ref={containerRef}
          className="theme-section min-h-screen w-full bg-[#F1EFE7] text-[#050505] dark:bg-[#050505] dark:text-white relative overflow-hidden font-sans selection:bg-[#CCFF00] selection:text-black pt-24 pb-32 transition-colors duration-500"
        >
          <BrutalistCursor />
