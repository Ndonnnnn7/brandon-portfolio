...
const Projects = () => {
  ...
  return (
    <section
      id="projects"
      ref={sectionRef}
      className="theme-section relative w-full overflow-hidden bg-[#F1EFE7] py-24 font-sans text-[#050505] dark:bg-[#070707] dark:text-white selection:bg-[#CCFF00] selection:text-black md:py-40 transition-colors duration-500"
    >
      <div
      ...
      />
      <div className="absolute inset-0 z-0 pointer-events-none bg-[radial-gradient(circle_at_50%_50%,transparent_0%,#F1EFE7_100%)] dark:bg-[radial-gradient(circle_at_50%_50%,transparent_0%,#070707_100%)]" />
