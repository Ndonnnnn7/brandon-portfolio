...
const Projects = () => {
  ...
  // --- DATA PROJECTS ---
  // PASTIKAN DATA INI SINKRON DENGAN DATA DI ProjectDetail.jsx
  // (Idealnya data ini dipisah ke file terendiri seperti 'data/projects.js' lalu di-import)
  const projects = [
    {
      id: 1,
      title: "InterStellar",
    ...
    },
    {
      ...
      description:
        "App that helps students access scholarships, mentorship, and various educational.",
      tech: ["Figma", "Prototyping", "User Testing"],
      links: {
    ...
    },
    {
      ...
      description:
        "App that analyzes legal documents or issues from photos or text and suggests relevant laws and actions.",
      tech: ["Figma", "Prototyping", "User Testing"],
      links: {
    ...
    },
    {
      ...
      description:
        "An platform designed to help students access emotional and psychological support more easily",
      tech: ["Figma", "Prototyping", "User Testing"],
      links: {
  ...
  return (
    <section
      id="projects"
      className="relative w-full min-h-screen py-24 text-white"
    >
      {/* Background Glow */}
          ...
          <AnimatePresence mode="popLayout">
            {filteredProjects.map((project) => (
              <motion.div
                ...
                animate="visible"
                exit="exit"
                // 3. Tambahkan Handler Navigasi di sini
                onClick={() => navigate(`/project/${project.id}`)}
                className={`group relative rounded-3xl overflow-hidden border border-white/10 bg-white/5 hover:border-white/20 transition-all duration-500 cursor-pointer ${
                  project.featured
                  ...
                  <div className="transform translate-y-4 group-hover:translate-y-0 transition-transform duration-500">
                    ...
                    <p
                      className={`text-gray-300 line-clamp-2 mb-4 ${
                        project.featured ? "text-base max-w-lg" : "text-sm"
                      }`}
                    >
                      {project.description}
                    </p>
