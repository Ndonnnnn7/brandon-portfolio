...
const BackgroundAnimation = () => {
  return (
    <div className="fixed top-0 left-0 w-full h-full -z-20 overflow-hidden bg-canvas">
      ...
      <div
        ...
        style={{ backgroundColor: "#8FE8F6", animationDuration: "8s" }}
      ></div>
      ...
      <div
        ...
        style={{ backgroundColor: "#C8F7D7", animationDuration: "12s" }}
      ></div>
      ...
      <div
        ...
        style={{ backgroundColor: "#8FE8F6", animationDuration: "10s" }}
      ></div>
      ...
      <div
        ...
        style={{ backgroundColor: "#8FE8F6", animationDuration: "15s" }}
      ></div>
      ...
      <style>{`
        .bg-radial-vignette {
          background: radial-gradient(circle at 50% 50%, transparent 20%, rgba(143, 232, 246, 0.16) 100%);
        }
      `}</style>
    </div>
  );
